#line 1 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
...
#line 16 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
...
#line 39 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
...
#line 72 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
typedef struct
{
...
#line 39 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 63 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 86 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 102 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 118 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 134 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 150 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
extern const T_i2c_obj _MIKROBUS5_I2C;


extern const T_uart_obj _MIKROBUS5_UART;
#line 175 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
extern const uint8_t _LOG_USBUART;
#line 188 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
T_mikrobus_ret mikrobus_gpioInit(T_mikrobus_soc bus, T_mikrobus_pin pin, T_gpio_dir direction);
#line 197 "d:/its/akademik/ta/mikromedia ecg syn/fusion_v8_stm32f407zg.h"
...
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_gpio.c"
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
#line 13 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_gpio.c"
...
static uint8_t _getCS_3() { return GPIOB_IDR.B12; }
...
static void _setCS_3(uint8_t value) { GPIOB_ODR.B12 = value; }
...
static uint8_t _getRST_4() { return GPIOG_IDR.B4; }
...
static void _setRST_4(uint8_t value) { GPIOG_ODR.B4 = value; }
...
static T_mikrobus_ret _gpioInit_2(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_CS_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_15);
 else
 ...
 case _MIKROBUS_INT_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOG_BASE, _GPIO_PINMASK_1);
 else
 GPIO_Digital_Output(&GPIOG_BASE, _GPIO_PINMASK_1);
 break;
 case _MIKROBUS_RX_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOA_BASE, _GPIO_PINMASK_3);
...
static T_mikrobus_ret _gpioInit_3(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_PWM_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOB_BASE, _GPIO_PINMASK_3);
 else
 GPIO_Digital_Output(&GPIOB_BASE, _GPIO_PINMASK_3);
 break;
 case _MIKROBUS_INT_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOG_BASE, _GPIO_PINMASK_2);
 else
 GPIO_Digital_Output(&GPIOG_BASE, _GPIO_PINMASK_2);
 break;
 case _MIKROBUS_RX_PIN:
 if (dir == _GPIO_INPUT)
 ...
 case _MIKROBUS_TX_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOC_BASE, _GPIO_PINMASK_6);
 else
...
static T_mikrobus_ret _gpioInit_4(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_RST_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOG_BASE, _GPIO_PINMASK_4);
 else
 GPIO_Digital_Output(&GPIOG_BASE, _GPIO_PINMASK_4);
 break;
 case _MIKROBUS_CS_PIN:
 if (dir == _GPIO_INPUT)
 ...
 case _MIKROBUS_INT_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOG_BASE, _GPIO_PINMASK_3);
 else
 GPIO_Digital_Output(&GPIOG_BASE, _GPIO_PINMASK_3);
 break;
 case _MIKROBUS_RX_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOC_BASE, _GPIO_PINMASK_7);
...
static T_mikrobus_ret _gpioInit_5(T_mikrobus_pin pin, T_gpio_dir dir)
{
 ...
 case _MIKROBUS_RST_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOE_BASE, _GPIO_PINMASK_15);
 else
 GPIO_Digital_Output(&GPIOE_BASE, _GPIO_PINMASK_15);
 break;
 case _MIKROBUS_CS_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOD_BASE, _GPIO_PINMASK_7);
 else
 GPIO_Digital_Output(&GPIOD_BASE, _GPIO_PINMASK_7);
 break;
 case _MIKROBUS_SCK_PIN:
 if (dir == _GPIO_INPUT)
 GPIO_Digital_Input(&GPIOC_BASE, _GPIO_PINMASK_10);
 else
...
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_i2c.c"
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
#line 13 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_i2c.c"
...
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_uart.c"
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
#line 13 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_uart.c"
...
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_log.c"
#line 1 "d:/its/akademik/ta/mikromedia ecg syn/__t_stm32.h"
#line 13 "d:/its/akademik/ta/mikromedia ecg syn/__fuv8_stm32f407zg_log.c"
...
#line 38 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
...
#line 143 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
...
#line 162 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
T_mikrobus_ret mikrobus_gpioInit(T_mikrobus_soc bus, T_mikrobus_pin pin, T_gpio_dir direction)
{
 switch( bus )
 {
...
#line 184 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
 default : return _MIKROBUS_ERR_BUS;
 }
 return _MIKROBUS_OK;
}
#line 222 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
T_mikrobus_ret mikrobus_i2cInit(T_mikrobus_soc bus, const uint32_t *cfg)
{
 switch( bus )
 {
...
#line 244 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
 default : return _MIKROBUS_ERR_BUS;
 }
...
#line 275 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
 default : return _MIKROBUS_ERR_BUS;
 }
 return _MIKROBUS_OK;
}
...
#line 306 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
 case _LOG_USBUART : return _log_initUart( baud );
#line 314 "D:/ITS/AKADEMIK/TA/Mikromedia ECG syn/fusion_v8_STM32F407ZG.c"
 default : return _MIKROBUS_ERR_BUS;
 }
 return _MIKROBUS_OK;
}
